...
$tabla="<table id='contenedor' class='tabla contenedor-grande'>
				<caption>Tabla de asistencia</caption>
				<thead class='iz'>
				<tr>
					<th class='iz'>Nombre</th>
				...
				<tbody>
					<tr>
						<td class='iz'>Francisco de Jesús Méndez Pelayo</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						<td class='iz'>Alfredo Esparza Robles</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						<td class='iz'>Juan Meza Dávalos</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
